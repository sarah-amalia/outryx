import { c as createComponent, s as spreadAttributes, u as unescapeHTML, a as renderTemplate, m as maybeRenderHead, r as renderComponent, d as addAttribute, b as createAstro, j as defineScriptVars, i as renderSlot, F as Fragment, k as renderHead, h as renderScript } from './astro/server_CZqp4cyz.mjs';
import 'piccolore';
import { $ as $$Image } from './_astro_assets_BLs88ZzV.mjs';
import 'clsx';
/* empty css                         */
...
}, "/workspaces/outryx/src/components/ui/ShortForm.astro", void 0);
...
const $$Footer = createComponent(($$result, $$props, $$slots) => {
  ...
  const links = [
    ...
    { name: "Help Center", href: "https://desk.zoho.com/portal/outryx/en/home" },
    { name: "API Documentation", href: "https://documenter.getpostman.com/view/47296527/2sBXqFLh6V" },
    { name: "Blog", href: "#Home" }
  ];
  ...
  })} </ul> </div> <div class="flex flex-col lg:flex-row mt-[66px] mb-[51px]"> <div class="flex text-center lg:text-start flex-col w-full lg:w-[30%]"> <h3 class="mb-5 text-center md:text-left text-2xl text-green">Contact us</h3> <div class="flex flex-col justify-between gap-4"> <span> support@outryx.zohodesk.com </span> <span></span> <span class="lg:w-3/4"></span> </div> </div> <div class="flex-grow my-10 lg:my-0 lg:ml-12"> ${renderComponent($$result, "ShortForm", $$ShortForm, {})} </div> </div> </div> <div class="h-[1px] bg-gray mb-5"></div> <div class="flex flex-col lg:flex-row h-20 justify-center mt-4 text-center md:justify-between md:mt-0"> <span>2026 outryx<a class="underline" target="_blank" href="https://astro.build"></a> <a class="underline" target="_blank" href="https://manulthanura.com"></a></span>&nbsp
<span> <a href="https://www.olgaskuja.design/" target="_blank" class="underline"></a> <a href="https://esteban-vasquez.netlify.app/" target="_blank" class="underline"></a> <span></span> <a class="underline" href="https://creativecommons.org/licenses/by/4.0/" target="_blank"></a> </span> </div> </div> </div> </section>`;
}, "/workspaces/outryx/src/components/ui/Footer.astro", void 0);
...
}, "/workspaces/outryx/node_modules/astro-navbar/src/Astronav.astro", void 0);
...
}, "/workspaces/outryx/node_modules/astro-navbar/src/components/MenuIcon.astro", void 0);
...
}, "/workspaces/outryx/node_modules/astro-navbar/src/components/OpenIcon.astro", void 0);
...
}, "/workspaces/outryx/node_modules/astro-navbar/src/components/CloseIcon.astro", void 0);
...
}, "/workspaces/outryx/node_modules/astro-navbar/src/components/MenuItems.astro", void 0);
...
}, "/workspaces/outryx/node_modules/astro-navbar/src/components/Dropdown.astro", void 0);
...
}, "/workspaces/outryx/node_modules/astro-navbar/src/components/DropdownSubmenu.astro", void 0);
...
}, "/workspaces/outryx/node_modules/astro-navbar/src/components/DropdownItems.astro", void 0);
...
}, "/workspaces/outryx/node_modules/astro-navbar/src/components/StickyHeader.astro", void 0);
...
}, "/workspaces/outryx/src/components/ui/Navbar.astro", void 0);
...
}, "/workspaces/outryx/src/components/seo/Seo.astro", void 0);
...
}, "/workspaces/outryx/src/layouts/MainHead.astro", void 0);
...
const $$MainLayout = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`<html lang="en" data-astro-cid-ouamjn2i> ${renderComponent($$result, "MainHead", $$MainHead, { ...props, "data-astro-cid-ouamjn2i": true })}${renderScript($$result, "/workspaces/outryx/src/layouts/MainLayout.astro?astro&type=script&index=0&lang.ts")}${maybeRenderHead()}<body class="bg-white font-grotesk" data-astro-cid-ouamjn2i> <main data-astro-cid-ouamjn2i> ${renderComponent($$result, "Navbar", $$Navbar, { "data-astro-cid-ouamjn2i": true })} ${renderSlot($$result, $$slots["default"])} ${renderComponent($$result, "Footer", $$Footer, { "data-astro-cid-ouamjn2i": true })} </main> </body></html>`;
}, "/workspaces/outryx/src/layouts/MainLayout.astro", void 0);
