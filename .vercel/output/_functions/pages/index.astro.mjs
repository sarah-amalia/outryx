/* empty css                                 */
import { c as createComponent, r as renderComponent, a as renderTemplate, m as maybeRenderHead, d as addAttribute, h as renderScript, b as createAstro } from '../chunks/astro/server_CZqp4cyz.mjs';
import 'piccolore';
import { $ as $$Image } from '../chunks/_astro_assets_BLs88ZzV.mjs';
import { $ as $$Card } from '../chunks/Card_D8OR4gMq.mjs';
import { b as $$Section, c as $$SectionTitle, $ as $$Sponsors, a as $$Services } from '../chunks/Services_DaMvzZWH.mjs';
import { l as larrow } from '../chunks/icon3_D4SrLSiU.mjs';
/* empty css                                 */
import { c as createSvgComponent, $ as $$MainLayout } from '../chunks/MainLayout_6ZqoEM1f.mjs';
import 'clsx';
...
const decorForm = new Proxy({"src":"/_astro/contact-pic.BrB0SfUf.png","width":692,"height":649,"format":"png"}, {
						get(target, name, receiver) {
							...
							if (name === 'fsPath') {
								return "/workspaces/outryx/src/assets/pics/contact-pic.png";
							}
...
const $$Form = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${maybeRenderHead()}<div class="flex relative justify-start items-center p-[60px] bg-[#F3F3F3] rounded-[45px] overflow-hidden" data-astro-cid-2lkv3ujd> <form name="zsWebToCase_1316748000000412023" id="zsWebToCase_1316748000000412023" action="https://desk.zoho.com/support/WebToCase" method="POST" enctype="multipart/form-data" class="bg-gray sm:p-6 h-full w-full lg:max-w-lg" data-astro-cid-2lkv3ujd> <input type="hidden" name="xnQsjsdp" value="edbsnc6c0d4bc795aa6aa9bfeb55ebccf4ab3" data-astro-cid-2lkv3ujd> <input type="hidden" name="xmIwtLD" value="edbsnf18151514662c50c70f6b3b80c78b387666a4a27327865f083ab37927ba6553d" data-astro-cid-2lkv3ujd> <input type="hidden" name="xJdfEaS" value="" data-astro-cid-2lkv3ujd> <input type="hidden" name="actionType" value="Q2FzZXM=" data-astro-cid-2lkv3ujd> <input type="hidden" id="property(module)" value="Cases" data-astro-cid-2lkv3ujd> <input type="hidden" name="returnURL" value="https://outryx.vercel.app/" data-astro-cid-2lkv3ujd> <div class="flex flex-col sm:flex-row gap-[35px] sm:items-center mb-10" data-astro-cid-2lkv3ujd> <div class="flex items-center gap-[14px]" data-astro-cid-2lkv3ujd> <input type="checkbox" id="checkbox1" name="checkbox1" class="form-checkbox text-black" data-astro-cid-2lkv3ujd> <label for="checkbox1" class="text-black" data-astro-cid-2lkv3ujd>Send ticket</label> </div> <div class="flex items-center gap-[14px]" data-astro-cid-2lkv3ujd></div> </div> <div class="mb-4" data-astro-cid-2lkv3ujd> <label for="name" class="block text-black mb-2" data-astro-cid-2lkv3ujd>Name*</label> <input type="text" id="name" name="Contact Name" placeholder="Name" maxlength="120" class="w-full px-[30px] py-[18px] border border-black rounded-[14px] text-black outline-none" data-astro-cid-2lkv3ujd> </div> <div class="mb-4" data-astro-cid-2lkv3ujd> <label for="email" class="block text-black mb-2" data-astro-cid-2lkv3ujd>Email*</label> <input type="email" id="email" name="Email" placeholder="Email" maxlength="120" class="w-full px-[30px] py-[18px] border border-black rounded-[14px] text-black outline-none" data-astro-cid-2lkv3ujd> </div> <div class="mb-4" data-astro-cid-2lkv3ujd> <label for="subject" class="block text-black mb-2" data-astro-cid-2lkv3ujd>Subject*</label> <input type="text" id="subject" name="Subject" placeholder="Subject" maxlength="255" class="w-full px-[30px] py-[18px] border border-black rounded-[14px] text-black outline-none" data-astro-cid-2lkv3ujd> </div> <div class="mb-4" data-astro-cid-2lkv3ujd> <label for="message" class="block text-black mb-2" data-astro-cid-2lkv3ujd>Message*</label> <textarea id="message" name="Description" placeholder="Message" maxlength="3000" class="w-full px-[30px] py-[18px] border border-black rounded-[14px] text-black outline-none" data-astro-cid-2lkv3ujd></textarea> </div> <button type="submit" id="zsSubmitButton_1316748000000412023" class="btn-primary w-full" data-astro-cid-2lkv3ujd>
Send
</button> </form> <picture class="absolute right-[-25%] top-[2%] bottom-[2%] hidden lg:block" data-astro-cid-2lkv3ujd> ${renderComponent($$result, "Image", $$Image, { "src": decorForm, "alt": "decor", "data-astro-cid-2lkv3ujd": true })} </picture> </div>  ${renderScript($$result, "/workspaces/outryx/src/components/ui/Form.astro?astro&type=script&index=0&lang.ts")}`;
}, "/workspaces/outryx/src/components/ui/Form.astro", void 0);

const $$Contact = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${renderComponent($$result, "Section", $$Section, { "id": "contact" }, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<div class="mb-[140px] relative"> ${renderComponent($$result2, "SectionTitle", $$SectionTitle, { "sectionTitle": "outryx Support", "description": "Experiencing an issue? Let us know and we'll get back to you shortly." })} ${renderComponent($$result2, "Form", $$Form, {})} </div> ` })}`;
}, "/workspaces/outryx/src/components/sections/Contact.astro", void 0);
...
const $$Hero = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${renderComponent($$result, "Section", $$Section, { "id": "home" }, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<div class="relative flex flex-col-reverse items-center md:flex-row" id="hero"> <div class="row items-center py-5 md:w-6/12 md:pb-20 md:pt-10"> <div class="text-left space-y-3"> <h1 class="text-4xl font-medium leading-none md:text-6xl text-center md:text-left">outryx-<br> email marketing <br> automation</h1> <p class="mt-6 mb-8 text-lg font-normal leading-7 sm:mb-12 text-center md:text-left md:pr-12">Welcome to our upcoming project</p> <div class="w-full justify-center md:justify-start items-center inline-flex"> <a href="https://github.com/manulthanura/Positivus" target="_blank" class="px-8 py-5 bg-zinc-900 hover:bg-white rounded-2xl text-center text-white hover:text-black border text-xl font-normal leading-7">Button
...
}, "/workspaces/outryx/src/components/sections/Hero.astro", void 0);
  ...
  const content = [
    {
      index: 1,
      title: "Process 1",
      description: "Upcoming elaboration"
    },
    {
      index: 2,
      title: "Process 2",
...
}, "/workspaces/outryx/src/components/ui/Accordion.astro", void 0);
...
}, "/workspaces/outryx/src/components/sections/Process.astro", void 0);
...
const propImg = new Proxy({"src":"/_astro/proposal-pic.DC7YnBHg.png","width":494,"height":395,"format":"png"}, {
						get(target, name, receiver) {
							...
							if (name === 'fsPath') {
								return "/workspaces/outryx/src/assets/pics/proposal-pic.png";
							}
...
Contact us today to learn more about how our email automation services can help your business grow and succeed online.
...
}, "/workspaces/outryx/src/components/sections/Proposal.astro", void 0);
...
}, "/workspaces/outryx/src/components/ui/TeamCard.astro", void 0);
...
const p1 = new Proxy({"src":"/_astro/t1.DCqpUh7U.png","width":106,"height":103,"format":"png"}, {
						get(target, name, receiver) {
							...
							if (name === 'fsPath') {
								return "/workspaces/outryx/src/assets/team/t1.png";
							}
...
const p2 = new Proxy({"src":"/_astro/t2.nG-pfUKH.png","width":103,"height":103,"format":"png"}, {
						get(target, name, receiver) {
							...
							if (name === 'fsPath') {
								return "/workspaces/outryx/src/assets/team/t2.png";
							}
...
const $$Team = createComponent(($$result, $$props, $$slots) => {
  const description = "Meet the skilled and experienced team behind our platform";
  const team = [
    {
      pic: p1,
      name: "Abdu Nur Ilham",
      role: "Marketing Lead",
      description: "Marketing strategy, marketing analysis, copywriting, email marketing/newsletter, social media marketing",
    ...
    },
    {
      ...
      description: "Handles support and system operations for outryx end-to-end. Covers help desk management, knowledge base, API documentation, and system monitoring.",
      link: "https://sarah-tw.vercel.app/"
    }
  ];
...
}, "/workspaces/outryx/src/components/sections/Team.astro", void 0);
